...
export const fetchDepartments = async () => {
  try {
    const response = await axios.get("https://empleados-backend.vercel.app/api/department", {
      headers: {
...
export const getEmployees = async (departmentId) => {
  try {
    const response = await axios.get(
      `https://empleados-backend.vercel.app/api/employee/department/${departmentId}`,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
